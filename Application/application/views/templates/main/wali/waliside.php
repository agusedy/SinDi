            ...
            <ul class="sidebar-menu">
                <li>
                    <a href="<?php echo site_url('wali');?>">
                        <i class="fa fa-dashboard"></i> <span>Raport</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo site_url('wali/rkelas/');?>">
                        <i class="fa fa-th"></i> <span>Peringkat Kelas</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo site_url('wali/rpararel/');?>">
                        <i class="fa fa-th"></i> <span>Peringkat Pararel</span>
                    </a>
                </li>
                <!-- <li class="treeview">
                    <a href="#">
